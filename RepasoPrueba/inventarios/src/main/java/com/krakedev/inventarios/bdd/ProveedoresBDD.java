...
public class ProveedoresBDD {
	...
	public Proveedor buscarPorId(String idProveedor) throws KrakeDevException {
	    Connection con = null;
	    PreparedStatement ps = null;
	    ResultSet rs = null;
	    ...
	    try {
	        ...
	        ps = con.prepareStatement(
	            "select prov.identificador_pk, prov.tipo_documento, td.descripcion, prov.nombre, prov.telefono, prov.correo, prov.direccion " +
	            "from proveedores prov " +
	            "join tipo_documentos td ON prov.tipo_documento = td.codigo " +
	            "where prov.identificador_pk = ?"
	        );
